...
class FunctionTool:
    ...
    """The original callable wrapped by @function_tool, if created via the decorator.

    None for FunctionTool instances constructed manually without a backing Python function.
    """
    ...
    def func(self) -> ToolFunction[...] | None:
        ...
        Useful for testing tool logic directly without spinning up a full agent, or for
        frameworks that need to inspect or relocate the underlying function.

        Returns None for FunctionTool instances constructed manually without a backing function.
        """
        return self._func
